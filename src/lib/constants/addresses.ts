...
export const DEPOSIT_ADDRESS = compileDepositContract();
export const SELL_ORDER_ADDRESS = compileSellContract();
export const BUY_ORDER_ADDRESS = compileBuyContract();
export const SWAP_ORDER_ADDRESS = compileSwapContract();
