<script lang="ts">
	...
	import { connectWeb3Wallet, loadUIState, loadWeb3WalletTokens, web3wallet_confirmedTokens, web3wallet_connected, web3wallet_wallet_name } from '$lib/ui/ui_state';
        ...
        {#if $web3wallet_connected}
            <div id="scroll" style="position:relative">
                ...
                <div in:fade out:fade>
                    ...
                    <div style="color: var(--primary-text);">Available: {$web3wallet_confirmedTokens.find(ct => ct.tokenId == t.tokenId)?.amount??0}</div>
                    <div class="flex gap-4">
                        ...
                        class="underline" style="color: var(--tint-blue-base);">MAX</button>
                    </div>
                    </div>
                </div>
                {/each}
