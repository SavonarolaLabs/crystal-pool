...
export function proxyOutputs(transaction: UnconfirmedTransaction): BoxParameters[] {
	...
	return transaction.outputs
		.map((o, i) => {
			if (
				o.ergoTree.startsWith(starts) &&
				o.ergoTree.endsWith(ends) &&
				o.ergoTree.includes(includes)
			) {
				const ergoTree = ErgoTree.from_base16_bytes(o.ergoTree);
				return {
